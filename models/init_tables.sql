...
CREATE TABLE blocks(id SERIAL PRIMARY KEY, teacher_id INT REFERENCES teachers(id) ON DELETE CASCADE, course_id VARCHAR(255) REFERENCES courses(id) ON DELETE CASCADE, room VARCHAR(255), time INT, seats INT);
